...
if __name__ == "__main__":
    ...
    benchmarks, stat_data, labels, names = get_stats(descriptor_data, args.simulation_path, args.output_dir, stack_stats, stack_filenames, stack_types)
    plot_stack(benchmarks, stat_data, stat_file["plotinfo"]["stacked"]["ylabel"], stat_file["plotinfo"]["stacked"]["name"], stack_labels=labels)


# command: python plot_specs.py -o C:\Users\elmig\OneDrive\Desktop\"Cse 220"\lab2_plots -d C:\Users\elmig\OneDrive\Desktop\"Cse 220"\lab2.json -s C:\Users\elmig\OneDrive\Desktop\"Cse 220"\simulations -p C:\Users\elmig\OneDrive\Desktop\"Cse 220"\stats.json
